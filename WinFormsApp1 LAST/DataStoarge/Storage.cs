            ...
            if (File.Exists("Temp_FILE.txt"))
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    if (line.Contains("Refrigetor"))
                        Stock.Add(new NewFolder.Refrigerator(sublines[6], int.Parse(sublines[10]), int.Parse(sublines[12]), int.Parse(sublines[8])));
                        ...
                        Stock.Add(new NewFolder.Oven(sublines[6], int.Parse(sublines[10]), int.Parse(sublines[12]), int.Parse(sublines[8])));
